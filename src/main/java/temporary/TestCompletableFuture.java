...
public class TestCompletableFuture {
	...
	public static void main(String[] args) {
	 ...
	 private static void thenApplyAsyncWithExecutorExample() {
		 CompletableFuture.supplyAsync(() -> getString()).thenApply(str -> str.toLowerCase())
			.thenCompose(lower -> CompletableFuture.supplyAsync(() -> getString()).thenApply(str -> str.toUpperCase())
													.thenApply(sw -> sw + lower))
...
class TaskSupplier{
 ...
 class AnotherTestCompletableFuture {
	public static void notMain(String args[]) {

	CompletableFuture<Boolean> validateIsCompleted = CompletableFuture.supplyAsync(()-> true);
	CompletableFuture<Boolean> validateIsPaymentCompleted = CompletableFuture.supplyAsync(()-> true);
	@SuppressWarnings("unused")
	CompletableFuture<Boolean> validateIsValid = CompletableFuture.supplyAsync(()-> false)
			.thenCombine(validateIsPaymentCompleted, (a,b) -> a && b)
			.thenCombine(validateIsCompleted, (a,b) -> a && b);
	
	CompletableFuture<Integer> goog= CompletableFuture.supplyAsync(()-> getStockPrice());
	CompletableFuture<Integer> amzn= CompletableFuture.supplyAsync(()-> getStockPrice());
	goog.thenCombine(amzn, (a,b) -> a+b)
	.thenAccept(x -> System.out.println(x));
	
	
	//CompletableFuture.supplyAsync(TestCompletableFuture::getStockPrice).thenAccept(System.out::println);
	CompletableFuture.supplyAsync(() -> getStockPrice()).thenAccept(System.out::println);
	CompletableFuture.supplyAsync(() -> getString()).thenAccept(System.out::println);
